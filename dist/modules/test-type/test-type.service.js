...
let TestTypesService = class TestTypesService {
    ...
    async create(createTestTypeDto) {
        ...
        if (existingTestType) {
            throw new common_1.BadRequestException(`Test type with id ${createTestTypeDto.id} already exists`);
        }
    ...
    async update(id, updateTestTypeDto) {
        ...
        if (updateTestTypeDto.id && updateTestTypeDto.id !== id) {
            ...
            if (duplicateTestType) {
                throw new common_1.BadRequestException(`Test type with id ${updateTestTypeDto.id} already exists`);
            }
        }
